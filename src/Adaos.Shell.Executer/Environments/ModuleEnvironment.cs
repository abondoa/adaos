...
using Adaos.Shell.Executer.ModuleManaging;
...
namespace Adaos.Shell.Executer.Environments
{
    class ModuleEnvironment : Environment
    {
        ...
        public override IEnumerable<IEnvironmentUniqueIdentifier> Dependencies { get { yield return new EnvironmentUniqueIdentifier("environment"); } }
        ...
        public ModuleEnvironment(StreamWriter output, EnvironmentEnvironment envEnv, IVirtualMachine vm)
        {
            ...
            _moduleManager = new ModuleManager(_vm);
            _envEnv = envEnv;
            _output = output;
